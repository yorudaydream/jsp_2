...
<head>
  ...
  .noticeList {width:80%; height:auto; border-top : 1px solid #ddd; border-bottom : 1px solid #ddd;}
  .noticeList thead{text-align:center;}
  .noticeList tbody{}
			...
			<form action="./noticeWriteForm.jsp">
				<table class="noticeList table table-hover">
					...
					<tbody>
						<tr>
							<td></td>
							<td><a href="./noticeSelectOne?num=<%= ndt.getNum() %>"></a></td>
							<td></td>
							<td></td>
							<td></td>
						</tr>
